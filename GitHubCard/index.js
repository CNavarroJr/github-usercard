...
// This is how to create the axios to get access to the API
...
function userCard(follower){
  ...
  axios.get('https://api.github.com/users/CNavarroJr')
    .then((response) => {
  ...
  axios.get('https://api.github.com/users/CNavarroJr/followers')
